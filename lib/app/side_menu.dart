                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (_) => SideMenuDetailPage(
                            title: sideMenuItem[index]['text'], key: sideMenuItem[index]['text'],
                          )));
                }
              },
              child: Padding(
            ...
            return FlatButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) => SideMenuDetailPage(
                          title: sideMenuItem[index + 2]['text'], key: sideMenuItem[index + 2]['text'],
                        )));
              },
              child: Padding(
                padding: const EdgeInsets.only(top: 25, left: 25),
            ...
            return FlatButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) => SideMenuDetailPage(
                          title: sideMenuItem[index + 7]['text'], key: sideMenuItem[index + 7]['text'],
                        )));
              },
              child: Padding(
                padding: const EdgeInsets.only(top: 25, left: 25),
            ...
            return FlatButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) => SideMenuDetailPage(
                          title: sideMenuItem[index + 9]['text'], key: sideMenuItem[index + 9]['text'],
                        )));
              },
              child: Padding(
                padding: const EdgeInsets.only(top: 25, left: 25),
